<template>
  <div>
          ...
          <div class="table-responsive">
            ...
            >
              <template v-slot:cell(nama_kategori)="data">
                <b-badge variant="default">{{ data.item.nama_kategori }}</b-badge>
              </template>
              <template v-slot:cell(Aksi)="data">
                <b-button
                  size="sm"
                  v-on:click="Edit(data.item.id_kategori)"
                  v-b-modal.modalkategori
                ...
                <b-button
                  size="sm"
                  v-on:click="Drop(data.item.id_kategori)"
    ...
    <b-modal id="modalkategori" @ok="Save">
      <template v-slot:modal-title> Form Data kategori </template>
      <form ref="form">
...
module.exports = {
  ...
  methods: {
    getData: function () {
      ...
      this.axios
        .get("/kategori/" + this.perPage + "/" + offset, conf)
        .then((response) => {
    ...
    Save: function () {
      ...
      if (this.action === "insert") {
        ...
        this.axios
          .put("/kategori/" + this.id_kategori, form, conf)
          .then((response) => {
            this.message = "Mohon tunggu...";
            if (this.search == "") {
              this.getData();
