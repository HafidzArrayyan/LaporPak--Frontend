<template>
  <div>
        ...
        <div class="card">
          ...
          <div class="table-responsive">
            ...
            <!-- <div class="text-center my-3">
                            <large class="text-success">{{ message }}</large>
                        </div> -->
            <div class="text-center my-3">
              <b-badge
    ...
    <b-modal id="modalEdit" @ok="Save">
      <template v-slot:modal-title> Form Data Penduduk </template>
      <form ref="form">
        ...
        <div class="form-group">
          <label for="level" class="form-control-label">Level</label><br />
          <b-badge variant="info" v-if="level === 'masyarakat'">{{
            level
          }}</b-badge>
        </div>
      </form>
    ...
    <b-modal id="modalPenduduk" @ok="Save">
      <template v-slot:modal-title> Form Data Penduduk </template>
      <form ref="form">
        <div class="form-group">
          <label for="nama" class="form-control-label">Nama Lengkap</label>
      ...
      this.axios
        ...
        .then((response) => {
          if (response.data.success == true) {
            this.message = "";
            this.penduduk = response.data.data.user;
      ...
      this.axios
        ...
        .then((response) => {
          if (response.data.success == true) {
            ...
            this.message = "Gagal menampilkan data penduduk.";
            this.$router.push({ name: "penduduk" });
          }
        })
        .catch((error) => {
          console.log(error);
